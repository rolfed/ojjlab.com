...
--color-brand-light: color-mix(in oklab, var(--color-brand-dark), var(--color-pop-dark) 15%)
```
...
```css
--color-accent-light: #f2d680 (Gold/Yellow)
--color-accent-dark: #a67c53 (Bronze/Brown)
```
...
#### Primary Backgrounds
```css
--color-bg-dark: #172601 (Deep Green)
--color-bg-light: #365902 (Forest Green)
```
...
#### Neutral Backgrounds
```css
--color-pop-dark: #ffffff (Pure White)
--color-pop-light: #000000 (Pure Black)
--color-dark: #000000
--color-light: #ffffff
```
...
--icon-fill: 1 (filled style)
--icon-wght: 300 (weight)
--icon-grad: 0 (gradient)
--icon-opsz: 24 (optical size)
```
